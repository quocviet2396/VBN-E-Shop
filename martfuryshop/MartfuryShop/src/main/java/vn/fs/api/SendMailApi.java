...
import vn.fs.entity.EmailRequest;
...
public class SendMailApi {
	...
	public ResponseEntity<Integer> sendOpt(@RequestBody String email) {
	 ...
	 @PostMapping("/sendotpflutter")
	    public ResponseEntity<Integer> sendOpt(@RequestBody EmailRequest emailRequest) {
	...
	public void sendMailOtp(String email, int Otp, String title) {
		String body = "<div>\r\n" + "        <h3>Mã OTP đăng ký tài khoản của bạn là: <span style=\"color:red; font-weight: bold;\">"
				+ Otp + "</span></h3>\r\n" + "    </div>";
